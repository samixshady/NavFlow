  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-white hidden sm:block">Organizations</h1>
            </div>
            ...
            <div className="hidden md:flex items-center gap-6">
              ...
              <button onClick={() => alert('Create organization functionality coming soon')} className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">Organizations</h2>
          <p className="text-gray-400">Manage your teams and organizations</p>
        </div>
        ...
        {organizations.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-6">Create your first organization to collaborate with your team</p>
