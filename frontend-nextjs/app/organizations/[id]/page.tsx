        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-3 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
            <div className="flex items-start gap-4 flex-1 min-w-0">
              <div className="w-16 h-16 flex-shrink-0 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center shadow-lg">
                ...
                {isEditing ? (
                  ...
                  <>
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                        {organization.name}
                      </h1>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mb-3 break-words" style={{ wordBreak: 'break-word', overflowWrap: 'break-word' }}>
                ...
                {organization.members.slice(0, 5).map((member) => (
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0 mr-2">
                      <div className="w-10 h-10 flex-shrink-0 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="font-medium text-gray-900 dark:text-white break-words">{member.user_name}</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400 break-words">{member.user_email}</p>
                          </div>
                        </div>
                      </td>
                      <td className="py-4 px-4">
